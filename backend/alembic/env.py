...
def run_migrations_offline() -> None:
    ...
    # Use DATABASE_URL from environment/settings, fallback to alembic.ini
...
async def run_async_migrations() -> None:
    ...
    # Use DATABASE_URL from environment/settings, fallback to alembic.ini
    configuration["sqlalchemy.url"] = settings.DATABASE_URL or config.get_main_option("sqlalchemy.url")
